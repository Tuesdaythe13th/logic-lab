...
// Export the Chatbox function as the default export
export default function Chatbox() {
  const [message, setMessage] = useState('')
  const [chatMessages, setChatMessages] = useState<any[]>([]) // Use any[] for now, adjust if needed
  ...
  const handleCarouselChange = (direction: 'prev' | 'next') => { // Explicitly define the type
