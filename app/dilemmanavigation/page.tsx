...
export default function Component() {
  ...
  return (
    <div className="w-[375px] h-[812px] bg-white rounded-[60px] overflow-hidden shadow-xl border-[14px] border-black relative flex flex-col items-center justify-center"> 
      {/* Added items-center and justify-center to the outermost div's className */}
      {/* iPhone-style notch */}
