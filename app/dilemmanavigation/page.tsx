...
export default function Component() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-[375px] h-[812px] bg-white rounded-[40px] overflow-hidden shadow-xl border-[12px] border-black relative flex flex-col items-center justify-center">
        {/* iPhone-style notch */}
