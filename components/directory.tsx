...
export default function Component() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1 bg-white flex flex-col items-center justify-center p-8 gap-8 max-w-sm mx-auto iphone-screen">
        ...
        <Link href="/mynotebook">
          <Button className="bg-white text-black rounded-full px-8 py-3 animate-pulse text-lg mb-4" >
            Go to my notebook
          </Button>
        </Link>
      </main>
      <div className="absolute bottom-0 left-0 w-full h-1 bg-gray-300 rounded-full"></div>
    </div>
  );
}
